# Keycloak Microservice Client OpendID Authentication 2.0

keystore bearer only webapp/WEB-IF/keycloak.json

# Postman

appclient-oicd.postman_collection.json
...
To build the final jar and optimize the appclient application for production, run:
